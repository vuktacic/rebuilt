...
function render() {
  ...
  elements.uploadButton.textContent = state.phase === "uploading" ? "Uploading…" : "Analyze video →";
...
function progressPercent(current) {
  ...
  return { queued: 28, extracting: 52, generating: 78, ready: 100, failed: 100 }[current.status] || 0;
}
